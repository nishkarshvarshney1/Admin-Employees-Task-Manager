...
const AcceptTask = ({data}) => {
  return (
       <div className='text-black w-100 bg-(--yellow) h-90 shrink-0 rounded-lg p-5 flex flex-col justify-between'>
      ...
      <button className='bg-green-500 p-3 rounded'>Mark as completed</button>
      </div>
    </div>
  )
}
